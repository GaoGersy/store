...
public class StepB1DeleteUntarFiles extends BaseStep {

    public StepB1DeleteUntarFiles(IStep step) {
        super(step);
    }
    ...
    public boolean start() {
        ...
        StepB1PreHande step = (StepB1PreHande) getStep();
        StepB1UnTar stepIRSUnTar = (StepB1UnTar) step.getStep();
