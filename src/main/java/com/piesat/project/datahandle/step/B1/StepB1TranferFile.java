...
public class StepB1TranferFile extends BaseStep {

    public StepB1TranferFile(IStep step) {
        super(step);
    }
    ...
    public boolean start() {
        ...
        String projectPath = PieOrthorParameterHelper.PROPERTIES_MAP.get("PROJECT_PATH")+"B1";
