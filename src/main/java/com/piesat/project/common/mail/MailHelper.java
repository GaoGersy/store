 ...
 * the License.
 */
package com.piesat.project.common.mail;

import com.piesat.project.common.utils.CharsetUtil;
...
public class MailHelper {
	...
	public String getHtmltext( String tplName, Map<String, Object> data ) {
		return mergeTemplateIntoString(this.velocityEngine, tplName, getCharset(), data);
	}
