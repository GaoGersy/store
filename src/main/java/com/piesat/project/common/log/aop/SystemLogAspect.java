package com.piesat.project.common.log.aop;


import com.piesat.project.common.log.DateUtils;
...
import com.piesat.project.common.utils.UUIDUtils;
...
public class SystemLogAspect {
    ...
    private static final ThreadLocal<LogBean> logThreadLocal =
            new NamedThreadLocal<LogBean>("ThreadLocal log");
...
//	private ThreadPoolTaskExecutor threadPoolTaskExecutor;
     ...
     * Service层切点
     */
    @Pointcut("@annotation(com.piesat.project.common.log.annotation.SystemServiceLog)")
     ...
     * Controller层切点 注解拦截
     */
    @Pointcut("@annotation(com.piesat.project.common.log.annotation.SystemControllerLog)")
     ...
     * 方法规则拦截
     */
    @Pointcut("execution(* com.piesat.project.controller.*.*(..))")
